...
# Generate standard YAML header with comment block
...
create_empty_aliases_file() {
    generate_yaml_header "Generated by DockerKit tools/lib/services/aliases.sh" "No .local projects found - empty configuration" > "$ALIASES_FILE"
    echo "services: {}" >> "$ALIASES_FILE"
